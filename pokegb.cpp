...
#include                                                                                                      <SDL2/SDL.h>  /******************************************/
#include                                                                                                      "mman.h"  /*     POKEGB by Ben Smith (June 2021)    */
#include                                                                                                        <unistd.h>  /* -------------------------------------- */
...
#define e(_,__)                                                              L(_,1)P __:f=(b-_)/8,d=b==__||!(F&aj[f])^f&1;  /******************************************/
  ...
  S=(g*)mmap(0,1<<20,1,1,open("PokemonRed.gb",0),0))+32768;c=    open("rom.sav",258,0666);ftruncate(c,32768);SDL_Init(     32+0+0);auto*aa=SDL_CreateRenderer(SDL_CreateWindow(
 "MinPokeGB",20,20,800,640,4),-1,4);C=ad=(g*)mmap(0,32768,3,  1,c,0);v=(g*)SDL_GetKeyboardState(0);z=145;af=44032;    auto*ab=SDL_CreateTexture(aa,376840196,1,160,144);for(
